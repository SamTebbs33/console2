...
#define PPU_CODE_END (8 * 1024)
#define PPU_TABLES_START (8 * 1024)
#define PPU_TABLES_END (PPU_TABLES_START + 8 * 1024)
#define PPU_DEFS_START (16 * 1024)
#define PPU_DEFS_END (PPU_DEFS_START + 16 * 1024)
