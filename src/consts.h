...
#define SPRITE_ENTRY_SIZE (5)
#define SPRITE_ENTRIES_NUM 64
#define SPRITE_ENTRIES_SIZE (SPRITE_ENTRIES_NUM * SPRITE_ENTRY_SIZE)
...
#define SPRITE_TABLE_SIZE (SPRITE_ENTRIES_NUM * SPRITE_ENTRY_SIZE)
#define TILE_TABLE_ADDR (SPRITE_TABLE_ADDR + SPRITE_ENTRIES_SIZE)
#define TILE_TABLE_SIZE (TILE_ENTRIES_NUM * TILE_ENTRY_SIZE)
#define PPU_REGS_ADDR (TILE_TABLE_ADDR + TILE_TABLE_SIZE)
